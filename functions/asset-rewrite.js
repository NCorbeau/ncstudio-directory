...
// Import domain-to-directory mapping function - will be used at build time
// During runtime, we'll use the pre-generated mapping from the build process
let domainToDirectory = {};

try {
  // Try to import the pre-generated mapping if it exists
  domainToDirectory = __DOMAIN_DIRECTORY_MAPPING__ || {};
} catch (e) {
  // Fallback to empty object if not available
  domainToDirectory = {};
  console.warn('Domain-to-directory mapping not available, using empty mapping');
}
